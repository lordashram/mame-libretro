...
inline ATTR_FORCE_INLINE gime_base_device::pixel_t gime_base_device::get_composite_color(int color)
{
	/* CMP colors
	 *
...
inline ATTR_FORCE_INLINE gime_base_device::pixel_t gime_base_device::get_rgb_color(int color)
{
...
inline ATTR_FORCE_INLINE void gime_base_device::update_memory(void)
{
...
inline ATTR_FORCE_INLINE UINT8 gime_base_device::read_gime_register(offs_t offset)
{
	offset &= 0x0F;
...
inline ATTR_FORCE_INLINE UINT8 gime_base_device::read_mmu_register(offs_t offset)
{
...
inline ATTR_FORCE_INLINE UINT8 gime_base_device::read_palette_register(offs_t offset)
{
...
inline ATTR_FORCE_INLINE UINT8 gime_base_device::read_floating_bus(void)
{
...
inline ATTR_FORCE_INLINE void gime_base_device::write_gime_register(offs_t offset, UINT8 data)
{
...
inline ATTR_FORCE_INLINE void gime_base_device::write_mmu_register(offs_t offset, UINT8 data)
{
	offset &= 0x0F;
...
inline ATTR_FORCE_INLINE void gime_base_device::write_palette_register(offs_t offset, UINT8 data)
{
	offset &= 0x0F;
...
inline ATTR_FORCE_INLINE void gime_base_device::write_sam_register(offs_t offset)
{
...
inline ATTR_FORCE_INLINE offs_t gime_base_device::get_video_base(void)
{
	offs_t result;
...
inline ATTR_FORCE_INLINE UINT16 gime_base_device::get_lines_per_row(void)
{
...
inline ATTR_FORCE_INLINE UINT32 gime_base_device::record_scanline_res(int scanline)
{
	int column;
...
inline ATTR_FORCE_INLINE UINT32 gime_base_device::emit_mc6847_samples(const scanline_record *scanline, int sample_start, int sample_count, pixel_t *pixels, const pixel_t *palette)
{
...
inline ATTR_FORCE_INLINE UINT32 gime_base_device::emit_gime_graphics_samples(const scanline_record *scanline, int sample_start, int sample_count, pixel_t *pixels, const pixel_t *palette)
{
...
template<int xscale>
inline ATTR_FORCE_INLINE UINT32 gime_base_device::emit_gime_text_samples(const scanline_record *scanline, int sample_start, int sample_count, pixel_t *pixels, const pixel_t *palette)
{
...
inline ATTR_FORCE_INLINE void gime_base_device::render_scanline(const scanline_record *scanline, pixel_t *pixels, int min_x, int max_x, palette_resolver *resolver)
{
...
inline ATTR_FORCE_INLINE gime_base_device::palette_resolver::palette_resolver(gime_base_device *gime, const pixel_t *palette)
{
	m_gime = gime;
	m_palette = palette;
...
inline ATTR_FORCE_INLINE const gime_base_device::pixel_t *gime_base_device::palette_resolver::get_palette(UINT16 palette_rotation)
{
...
inline ATTR_FORCE_INLINE gime_base_device::pixel_t gime_base_device::palette_resolver::lookup(UINT8 color)
{
	assert(color <= 63);
